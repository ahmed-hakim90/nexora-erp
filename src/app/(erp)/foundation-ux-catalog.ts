...
export const inventoryEntities: readonly FoundationEntity[] = [
  ...
  },
  {
    ...
    description: "Warehouse structure workspace with hierarchical barcode-ready storage locations.",
    fields: ["warehouse_key", "warehouse_type", "location_key", "location_kind", "barcode", "branch_id", "pickable", "receivable", "shippable", "status"],
    relationships: ["Branch", "Manager", "Cost Center", "Parent Location", "Default Operational Locations"],
  ...
  },
  {
    key: "lots",
    title: "Lots & Batches",
    description: "Lot and batch identity foundation with source, QC, lifecycle, barcode, and traceability metadata. No quantities or balances.",
    fields: ["lot_number", "product_id", "source_type", "qc_status", "lifecycle_state", "barcode", "expiry_date", "traceability_ready", "status"],
    relationships: ["Product", "Variant", "Supplier Party", "Handling Unit Contents", "Serial Numbers"],
    primaryActions: ["Create Lot", "Record Source Metadata", "Export"],
    permissions: ["inventory.lots.view", "inventory.lots.manage"],
    reconciliationItems: ["RI-02"],
  },
  {
    key: "serials",
    title: "Serial Numbers",
    description: "Serial Engine identity foundation with source, policy, verification, lifecycle, and traceability metadata. No quantities or generation runtime.",
    fields: ["serial_number", "product_id", "lot_id", "serial_source", "lifecycle_state", "serial_status", "verification_status", "barcode", "warranty_ready", "service_ready", "traceability_ready", "status"],
    relationships: ["Product", "Variant", "Lot", "Serial Policy", "Handling Unit", "Warehouse", "Location"],
    primaryActions: ["Create Serial", "Record Source Metadata", "Export"],
    permissions: ["inventory.serials.view", "inventory.serials.manage"],
    reconciliationItems: ["RI-02"],
  },
  {
    key: "handling-units",
    title: "Handling Units",
    description: "Physical container foundation for cartons, pallets, inner boxes, and bundles with barcode, lifecycle, and traceability metadata.",
    fields: ["hu_number", "hu_type_id", "warehouse_id", "location_id", "hu_status", "lifecycle_state", "barcode", "qr_payload", "split_ready", "merge_ready", "repack_ready"],
    relationships: ["Handling Unit Type", "Warehouse", "Location", "Parent HU", "Contents", "Lot", "Product", "Serial"],
    primaryActions: ["Create HU Type", "Create Handling Unit", "Record Content", "Export"],
    permissions: ["inventory.handling-units.view", "inventory.handling-units.manage"],
    reconciliationItems: ["RI-02"],
  },
  {
    key: "stock",
  ...
  },
  {
    ...
    title: "Inventory Document Foundation",
    description: "Goods receipt/issue, transfer, adjustment, material, production, return, scrap, repack, and cycle count document contracts. Current state is projection-only.",
    fields: ["document_kind", "document_type", "document_status", "lifecycle_state", "source_app", "warehouse_context", "object_type", "inventory_status", "snapshot_metadata"],
    relationships: ["Business Document", "Document Line", "Inventory Object Ref", "Snapshot", "Current State Projection", "Ledger"],
    primaryActions: ["View Document Foundation", "Review Projection Contract", "Export Readiness"],
    permissions: ["inventory.movements.view", "inventory.movements.create"],
    reconciliationItems: ["RI-02"],
  },
  {
    key: "inventory-ledger",
    title: "Inventory Ledger",
    description: "Read-only immutable inventory history. Append-only ledger entries corrected through reversal only. No balance calculation.",
    fields: ["movement_type", "movement_direction", "quantity_delta", "inventory_object_type", "warehouse_id", "location_id", "inventory_status", "document_type", "document_id", "correlation_id", "event_type", "parent_entry_id"],
    relationships: ["Product", "Lot", "Serial", "Handling Unit", "Warehouse", "Location", "Inventory Document", "Document Line", "Current State Projection"],
    primaryActions: ["View Ledger History", "Filter by Document", "Filter by Correlation", "Export"],
