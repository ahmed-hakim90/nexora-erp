...
export function assertProductCategoryCanBeSaved(input: Readonly<Record<string, unknown>>) {
  ...
  if (typeof primaryCode === "string" && primaryCode !== primaryCode.toUpperCase()) {
    throw new ApplicationError({
      ...
      message: "Product Categories codes must be uppercase before persistence.",
    });
  }
