...
export const financeAppManifest = defineAppManifest({
  ...
  commands: [
    ...
    },
    {
      ...
      appKey: "finance",
      category: "navigation",
      href: "/erp/finance/documentation",
      key: "finance.documentation.open",
      label: "Open Finance Documentation",
      order: 11,
      requiredPermission: FINANCE_PERMISSIONS.accountsView,
      scope: "global",
      supportedExperiences: ["erp"],
  ...
  routes: [
    ...
    {
      experience: "erp",
      key: "finance.documentation",
      label: "Finance Documentation",
      path: "/erp/finance/documentation",
      requiredPermission: FINANCE_PERMISSIONS.accountsView,
    },
    {
      experience: "erp",
      key: "finance.reports-readiness",
      label: "Finance Reports Readiness",
