...
export function assertWarehouseLocationCanBeSaved(input: Readonly<Record<string, unknown>>) {
  ...
  if (typeof primaryCode === "string" && primaryCode !== primaryCode.toUpperCase()) {
    throw new ApplicationError({
      ...
      message: "Warehouse Locations codes must be uppercase before persistence.",
    });
  }
