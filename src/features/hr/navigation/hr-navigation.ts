...
export const HR_NAV_ITEMS: readonly HrNavItem[] = [
  ...
  { key: "employees", label: "Employees", labelAr: "الموظفون", href: "/erp/hr/employees", permission: HR_PERMISSIONS.employeesView, group: "personal", priority: 10 },
  ...
  { key: "overtime", label: "Overtime", labelAr: "العمل الإضافي", href: "/erp/hr/overtime", permission: HR_PERMISSIONS.overtimeView, group: "attendance", priority: 80 },
  { key: "overtime-reports", label: "Overtime Reports", labelAr: "تقارير العمل الإضافي", href: "/erp/hr/overtime/reports", permission: HR_PERMISSIONS.overtimeExport, group: "attendance", priority: 90 },
  { key: "late-early", label: "Late / Early", labelAr: "التأخير والانصراف", href: "/erp/hr/late-early", permission: HR_PERMISSIONS.lateView, group: "attendance", priority: 95 },
  { key: "late-early-reports", label: "Late/Early Reports", labelAr: "تقارير التأخير", href: "/erp/hr/late-early/reports", permission: HR_PERMISSIONS.lateExport, group: "attendance", priority: 96 },
  ...
  { key: "onboarding", label: "Onboarding", labelAr: "الانضمام", href: "/erp/hr/onboarding", permission: HR_PERMISSIONS.employeesView, group: "talent", priority: 20 },
  ...
  { key: "performance", label: "Performance", labelAr: "الأداء", href: "/erp/hr/performance", permission: HR_PERMISSIONS.employeesView, group: "talent", priority: 40 },
  { key: "succession", label: "Succession", labelAr: "التعاقب", href: "/erp/hr/succession", permission: HR_PERMISSIONS.employeesView, group: "talent", priority: 50 },
  ...
  { key: "custody", label: "Custody / Assets", labelAr: "العهدة / الأصول", href: "/erp/hr/custody", permission: HR_PERMISSIONS.employeesView, group: "documents", priority: 30 },
