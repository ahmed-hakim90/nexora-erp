...
export const MANUFACTURING_WAREHOUSE_ROLE_MAP = {
  raw_materials: { warehouseType: "raw_materials", label: "Raw materials", productionRole: "raw" },
  production_floor: { warehouseType: "production_buffer", label: "Production floor / buffer", productionRole: "floor" },
  finished_goods: { warehouseType: "finished_goods", label: "Finished goods", productionRole: "finished" },
  scrap: { warehouseType: "scrap", label: "Scrap", productionRole: "scrap" },
  qc: { warehouseType: "qc", label: "QC hold", productionRole: "qc" },
} as const;
