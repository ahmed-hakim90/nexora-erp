...
function toPayload(input: ReturnType<typeof inventoryProductMutationSchema.parse>, context: Awaited<ReturnType<typeof resolveCompanyRequestContext>>) {
  ...
  return {
    ...
    cycle_count_class: input.cycleCountClass ?? null,
    default_location_id: input.defaultLocationId ?? null,
    default_picking_strategy: input.defaultPickingStrategy ?? null,
    default_putaway_strategy: input.defaultPutawayStrategy ?? null,
    ...
    has_lot_tracking: input.hasLotTracking || input.trackingMode === "lot" || input.trackingMode === "lot_serial",
    has_serial_tracking: input.hasSerialTracking || input.trackingMode === "serial" || input.trackingMode === "lot_serial",
    ...
    lot_expiry_supported: input.lotExpirySupported,
    lot_internal_supported: input.lotInternalSupported,
    lot_manufacturing_date_supported: input.lotManufacturingDateSupported,
    lot_qc_required: input.lotQcRequired,
    lot_shelf_life_supported: input.lotShelfLifeSupported,
    lot_supplier_supported: input.lotSupplierSupported,
    ...
    packaging_carton_qty: input.packagingCartonQty ?? null,
    packaging_inner_box_qty: input.packagingInnerBoxQty ?? null,
    packaging_loose_units: input.packagingLooseUnits,
    packaging_pallet_carton_qty: input.packagingPalletCartonQty ?? null,
    ...
    requires_qc_before_release: input.requiresQcBeforeRelease,
    requires_reservation: input.requiresReservation,
    ...
    serial_allow_manual_override: input.serialAllowManualOverride,
    serial_duplicate_validation: input.serialDuplicateValidation,
    serial_generation_timing: input.serialGenerationTiming ?? null,
    serial_source: input.serialSource ?? null,
    ...
    warranty_duration_days: input.warrantyDurationDays ?? null,
    warranty_eligible: input.warrantyEligible,
    warranty_starts_from: input.warrantyStartsFrom ?? null,
...
function mapSavedProduct(row: Record<string, unknown>): InventoryProductRecord {
  return {
    ...
    commercialName: row.commercial_name as string | null,
    costObjectKey: row.cost_object_key as string | null,
    createdAt: row.created_at as string,
    createdBy: row.created_by as string | null,
    currencyId: row.currency_id as string | null,
    currencyLabel: null,
    cycleCountClass: row.cycle_count_class as InventoryProductRecord["cycleCountClass"],
    defaultLocationId: row.default_location_id as string | null,
    defaultPickingStrategy: row.default_picking_strategy as string | null,
    defaultPutawayStrategy: row.default_putaway_strategy as string | null,
    ...
    lotShelfLifeSupported: row.lot_shelf_life_supported as boolean,
    ...
    packagingCartonQty: nullableNumber(row.packaging_carton_qty),
    packagingInnerBoxQty: nullableNumber(row.packaging_inner_box_qty),
    packagingLooseUnits: row.packaging_loose_units as boolean,
    packagingPalletCartonQty: nullableNumber(row.packaging_pallet_carton_qty),
    ...
    requiresQcBeforeRelease: row.requires_qc_before_release as boolean,
    requiresReservation: row.requires_reservation as boolean,
    ...
    searchKeywords: jsonArray(row.search_keywords),
    ...
    serialGenerationTiming: row.serial_generation_timing as InventoryProductRecord["serialGenerationTiming"],
    serialSource: row.serial_source as InventoryProductRecord["serialSource"],
    ...
    warrantyDurationDays: nullableNumber(row.warranty_duration_days),
    warrantyEligible: row.warranty_eligible as boolean,
    warrantyStartsFrom: row.warranty_starts_from as InventoryProductRecord["warrantyStartsFrom"],
