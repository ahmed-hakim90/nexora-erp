...
export const PRODUCT_COLUMNS = [
  ...
  "serial_duplicate_validation",
  "serial_allow_manual_override",
  "lot_supplier_supported",
  "lot_internal_supported",
  "lot_expiry_supported",
  "lot_manufacturing_date_supported",
  "lot_qc_required",
  "lot_shelf_life_supported",
  "packaging_loose_units",
  "packaging_inner_box_qty",
  "packaging_carton_qty",
  "packaging_pallet_carton_qty",
  "allow_negative_stock",
  "requires_reservation",
  "requires_qc_before_release",
  "cycle_count_class",
  "warranty_eligible",
  "warranty_duration_days",
  "warranty_starts_from",
  "search_keywords",
  "is_discountable",
  "is_online_visible",
  "cost_object_key",
...
export async function loadInventoryProductsWorkspace(query: unknown = {}): Promise<InventoryProductWorkspaceData> {
  ...
  if (parsed.search) {
    ...
    if (term.length > 0) request = request.or(`product_key.ilike.%${term}%,sku.ilike.%${term}%,barcode.ilike.%${term}%,name.ilike.%${term}%,commercial_name.ilike.%${term}%,name_ar.ilike.%${term}%,online_title.ilike.%${term}%,brand.ilike.%${term}%`);
  }
