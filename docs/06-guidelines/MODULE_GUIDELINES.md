...
- **[Nexora Platform UX Constitution](NEXORA_PLATFORM_UX_CONSTITUTION.md)** — mandatory UX standards for every business module
- [Module Structure](../07-development/MODULE_STRUCTURE.md)
- [Platform Engines](../01-platform/WORKFLOW.md)

> **Note:** Canonical content lives here. Previous location: `docs/MODULE_GUIDELINES.md`.
