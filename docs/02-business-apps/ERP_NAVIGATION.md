# ERP Navigation and Information Architecture
...
> **Note:** Canonical content lives here. Previous location: `docs/ERP_INFORMATION_ARCHITECTURE.md`.
...
### HR — `/erp/hr` (ready — operational sprints active)

| Section | Page | Route | Status |
| --- | --- | --- | --- |
| Overview | Dashboard | `/erp/hr` | ready |
| Workforce | Employees | `/erp/hr/employees` | ready |
| Master Data | Organization | `/erp/hr/organization` | ready |
| Master Data | Positions & Jobs | `/erp/hr/positions-jobs` | ready |
| Operations | Assignments | `/erp/hr/assignments` | ready |
| Operations | Contracts | `/erp/hr/contracts` | ready |
| Operations | Attendance & Leave | `/erp/hr/attendance-leave` | ready |
| Operations | Compensation | `/erp/hr/compensation` | ready |
| Operations | Payroll Readiness | `/erp/hr/payroll-readiness` | ready |
| Operations | Requests | `/erp/hr/requests` | ready |
| Operations | Documents | `/erp/hr/documents` | ready |
| Operations | Custody | `/erp/hr/custody` | ready |
| Time | Attendance Devices · Processing · Overtime · Time Policies | `/erp/hr/attendance-devices` etc. | ready |
| Financial | Advances · Loans · Bonuses · Incentives · Penalties · Bank Accounts | `/erp/hr/advances` etc. | ready |
| Talent | Recruitment · Onboarding · Training · Performance · Succession | `/erp/hr/recruitment` etc. | ready |
| Dashboards | Department · Executive | `/erp/hr/dashboards/department` · `/erp/hr/dashboards/executive` | ready |
| Reports | HR Reports | `/erp/hr/reports` | ready |
| Settings | HR Settings | `/erp/hr/settings` | ready |

See [HR.md](HR.md) and [Operational Roadmap](../00-overview/OPERATIONAL_ROADMAP.md) for sprint status.
