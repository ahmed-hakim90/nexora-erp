...
- [Finance App](../02-business-apps/FINANCE.md)
- [Document Engine](DOCUMENT_ENGINE.md)
- [Cost Engine](COST_ENGINE.md)

> **Note:** Canonical content lives here. Previous location: `docs/FINANCIAL_PLATFORM_FOUNDATION.md`.
