...
- [Platform Kernel](PLATFORM_KERNEL.md)
- [Runtime](RUNTIME.md)
- [Platform Engines](WORKFLOW.md)
- [Security](SECURITY.md)
- [Data Layer](DATA_LAYER.md)

> **Note:** Canonical content lives here. Previous location: `docs/platform/01_PLATFORM_BLUEPRINT.md`.
