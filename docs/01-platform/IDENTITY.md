...
- [Platform Implementation Roadmap](PLATFORM_IMPLEMENTATION_ROADMAP.md)
- [Sprint 03 Security Foundation](../09-history/SPRINT_03_ENTERPRISE_SECURITY.md)

## Scope

Identity covers authentication, session resolution, tenant/company/branch membership, experience access (ERP vs Portal), and employee identity linkage.

## Platform Phases

See [Platform Implementation Roadmap](PLATFORM_IMPLEMENTATION_ROADMAP.md):

- **Phase 1: Platform Core Runtime** — `RequestContext`, `ActorContext`, correlation, server/client boundaries.
- **Phase 2: Identity, Session, And Experience Access** — `getCurrentUser()`, `resolveSessionContext()`, `requireExperienceAccess()`, tenant/company/branch selection.

## Sprint 03 Implementation Snapshot

Historical implementation details are archived in [Sprint 03](../09-history/SPRINT_03_ENTERPRISE_SECURITY.md).
