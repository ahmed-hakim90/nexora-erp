...
- [App Framework](../01-platform/APP_FRAMEWORK.md)
- [Module Guidelines](../06-guidelines/MODULE_GUIDELINES.md)
- [Testing](TESTING.md)

> **Note:** Canonical content lives here. Previous location: `docs/FEATURE_STRUCTURE.md`.
