...
values
  ...
  ('manufacturing.work-centers.view', 'View Work Centers', 'View work center foundation records.', 'standard'),
  ('manufacturing.work-centers.manage', 'Manage Work Centers', 'Create and update work center foundation records.', 'standard'),
